...
public class Background extends JComponent {
    ...
    public Background() {
        image = new ImageIcon(getClass().getResource("/FT_login/classy-restaurant.jpg"));
    }
    ...
    private void createBlurImage(Graphics2D g) {
        ...
        if (width > 0 && height > 0) {
            ...
            Shape shape = new FancyBorderRadius(width, height, "35% 65% 69% 31% / 61% 63% 37% 39%").getShape();
            g2.fill(shape);
