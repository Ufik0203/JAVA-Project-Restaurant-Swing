 ...
 * @author mario
 */
public class Background_Regist extends JComponent {
    ...
    public Background_Regist() {
        image = new ImageIcon(getClass().getResource("/FT_regist/classy-restaurant_reg.png"));
    }
    ...
    private void createBlurImage(Graphics2D g) {
        ...
        if (width > 0 && height > 0) {
            ...
            Shape shape = new FancyBorderRadius(width, height, "100% 100% 100% 100% / 8% 23% 12% 30%").getShape();
            g2.fill(shape);
