...
public class PanelItem_desert extends JPanel {
    
    private BufferedImage bufferedImage;
    private Icon image;
    public PanelItem_desert() {
        image = new ImageIcon(getClass().getResource("/FT_menu/image/desert/dess-wp.jpg"));
