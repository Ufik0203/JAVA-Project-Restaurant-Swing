 ...
 * @author mario
 */
public class Panel_desert_b extends JComponent {
    ...
    public Panel_desert_b() {
        image = new ImageIcon(getClass().getResource("/FT_menu/image/desert/dess-wp-b.jpg"));
    }
    ...
    private void createBlurImage(Graphics2D g) {
        ...
        if (width > 0 && height > 0) {
            ...
            Shape shape = new FancyBorderRadius(width, height, "100% 100% 100% 100% / 0% 0% 0% 0%").getShape();
            g2.fill(shape);
    ...
    protected void paintComponent(Graphics grphcs) {
        if (bufferedImage != null) {
            ...
            Graphics2D g2 = img.createGraphics();
            g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
            g2.fill(new RoundRectangle2D.Double(0, 3, getWidth(), getHeight(), 13, 13));
            g2.setComposite(AlphaComposite.SrcIn);
