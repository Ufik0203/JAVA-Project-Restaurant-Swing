...
public class Button_circle_black extends JButton {

    private Shape shape;
    private final RippleEffect rippleEffect;

    public Button_circle_black() {
    ...
    public void setBounds(int i, int i1, int i2, int i3) {
        ...
        shape = new FancyBorderRadius(getWidth(), getHeight(), "51% 49% 50% 50% / 48% 50% 50% 52%").getShape();
    }
